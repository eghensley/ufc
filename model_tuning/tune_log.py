...
def tune_log():
    ...
    stage, log_clf, log_checkpoint_score = stage_init(name, dimension)
    ...
    if stage == 0:
        ...
        _save_model(stage, 'winner', name, log_clf, log_checkpoint_score, final = False)
        ...
        log_clf, log_checkpoint_score = test_scaler(log_clf, log_checkpoint_score, X, Y) 
        _save_model(stage, 'winner', name, log_clf, log_checkpoint_score, final = True)
...
def tune_linsvc():
    ...
    stage, linsvc_clf, linsvc_checkpoint_score = stage_init(name, dimension)
    ...
    if stage == 0:
        ...
        _save_model(stage, 'winner', name, linsvc_clf, linsvc_checkpoint_score, final = False)
        ...
        linsvc_clf, linsvc_checkpoint_score = test_scaler(linsvc_clf, linsvc_checkpoint_score, X, Y) 
        _save_model(stage, 'winner', name, linsvc_clf, linsvc_checkpoint_score, final = True)
...
def tune_rbfsvc():
    ...
    stage, rbfsvc_clf, rbfsvc_checkpoint_score = stage_init(name, dimension)
    ...
    if stage == 0:
        ...
        _save_model(stage, 'winner', name, rbfsvc_clf, rbfsvc_checkpoint_score, final = False)
        ...
        rbfsvc_clf, rbfsvc_checkpoint_score= test_scaler(rbfsvc_clf, rbfsvc_checkpoint_score, X, Y) 
        _save_model(stage, 'winner', name, rbfsvc_clf, rbfsvc_checkpoint_score, final = True)
...
def tune_polysvc():
    ...
    stage, polysvc_clf, polysvc_checkpoint_score = stage_init(name, dimension)
    ...
    if stage == 0:
        ...
        _save_model(stage, 'winner', name, polysvc_clf, polysvc_checkpoint_score, final = False)
        ...
        polysvc_clf, polysvc_checkpoint_score = test_scaler(polysvc_clf, polysvc_checkpoint_score, X, Y) 
        _save_model(stage, 'winner', name, polysvc_clf, polysvc_checkpoint_score, final = True)
...
def tune_lgb():
    ...
    stage, lgb_clf, lgb_checkpoint_score = stage_init(name, dimension)
    ...
    if stage == 0:
        ...
        _save_model(stage, 'winner', name, lgb_clf, lgb_checkpoint_score, final = False)
        ...
        _save_model(stage, 'winner', name, lgb_clf, lgb_checkpoint_score, final = True)
...
def tune_dart():
    ...
    stage, dart_clf, dart_checkpoint_score = stage_init(name, dimension)
    ...
    if stage == 0:
        ...
        _save_model(stage, 'winner', name, dart_clf, dart_checkpoint_score, final = False)
        ...
        _save_model(stage, 'winner', name, dart_clf, dart_checkpoint_score, final = True)
...
def tune_rf():
    ...
    stage, rf_clf, rf_checkpoint_score = stage_init(name, dimension)
    
    if stage == 0:
        rf_clf = RandomForestClassifier(random_state = 1108, n_estimators = 100)
        rf_clf, rf_checkpoint_score = pipe_init(X,Y,rf_clf)
        _save_model(stage, 'winner', name, rf_clf, rf_checkpoint_score, final = False)
        ...
        _save_model(stage, 'winner', name, rf_clf, rf_checkpoint_score, final = True)
...
def tune_knn():
    ...
    stage, knn_clf, knn_checkpoint_score = stage_init(name, dimension)
    
    if stage == 0:
        knn_clf = KNeighborsClassifier()
        knn_clf, knn_checkpoint_score = pipe_init(X,Y,knn_clf)
        _save_model(stage, 'winner', name, knn_clf, knn_checkpoint_score, final = False)
        ...
        _save_model(stage, 'winner', name, knn_clf, knn_checkpoint_score, final = True)
